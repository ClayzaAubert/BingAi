...
async def on_ready():
    ...
    client_status = discord.Status.online
    client_activity = discord.Activity(type=discord.ActivityType.playing, name = "/ask | /imagine")
    await client.change_presence(status = client_status, activity = client_activity)
...
async def imagine(interaction: discord.Interaction, prompt: str):
    """Ask Luna Ai to imagine visuals"""
    await interaction.response.defer(thinking=True)
